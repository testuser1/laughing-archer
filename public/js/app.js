...
$(function(){
	...
	function showLogout() { $('#signin').hide(); $('#signout').show(); }
	function showLogin() { $('#signin').show(); $('#signout').hide(); }
	// Mozilla persona
	...
	function enablePersona(currentUser) {
		navigator.id.watch({
		  ...
		  onlogin: function(assertion) {
		    ...
		    $.ajax({ /* <-- This example uses jQuery, but you can use whatever you'd like */
		      ...
		      success: function(res, status, xhr) { showLogout(); },
		      error: function(xhr, status, err) { alert("Login failure: " + err); showLogin(); }
		    });
		  },
		  onlogout: function() {
		    ...
		    $.ajax({
		      ...
		      success: function(res, status, xhr) { showLogin() },
		      error: function(xhr, status, err) { showLogin(); }
		    });
		  }
		});			
	}
    ...
    $.ajax({ 
      ...
      success: function(res, status, xhr) { 
      	...
      	enablePersona(data.email);
      	if (data && data.email) showLogout();
      },
